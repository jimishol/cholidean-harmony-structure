...
M.emissionLevels = {
  joints   = { active = 0.60, inactive = 0.00 },
  edges    = { active = 0.60, inactive = 0.00 },
  curves   = { active = 0.60, inactive = 0.00 },
  surfaces = { active = 0.60, inactive = 0.00 },
  labels   = { active = 0.60, inactive = 0.00 },
}
return M
